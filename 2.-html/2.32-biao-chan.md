...
{% content-ref url="jie-gou-lian-xi-san.md" %}
[jie-gou-lian-xi-san.md](jie-gou-lian-xi-san.md)
{% endcontent-ref %}
...
![資料未送出，輸入一般文字及選擇一張圖檔](<../.gitbook/assets/post\_before (1).png>)

按下資料送出後，如果有傳送成功，會出現如下圖，你所打的文字及所傳的圖片：

![資料送到後端程式，後端程式顯示文字及圖片](<../.gitbook/assets/post\_after (1).png>)
